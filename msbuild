...
//- ZTERM
#define MAX_SCREEN_TEXTDATA_SIZE (1<<18)
wchar_t screen_text_data[MAX_SCREEN_TEXTDATA_SIZE] = { 0 };
static void* pObject = nullptr;

using namespace winrt::Microsoft::Terminal::Control::implementation;
wchar_t* ztGetWindowData()
{
    screen_text_data[0] = L'\0';

    if (pObject)
    {
        ControlCore* pControl = reinterpret_cast<ControlCore*>(pObject);
        pControl->GetScreenData();
    }
...
namespace winrt::Microsoft::Terminal::Control::implementation
{
    ...
    void ControlCore::GetScreenData()
    {
        //-ZTERM
        size_t realSize = 0;
        const auto lock = _terminal->LockForReading();
