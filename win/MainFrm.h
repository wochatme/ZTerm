...
#endif 
/////////////////////////////////////////////////////////////////////////////////
static const unsigned int xbmpX[32 * 32] =
{
0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,
0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,
0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,
0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,0xFFFF0000,
...
public:
	...
	DWORD m_dwExtendedStyle = SPLIT_PROPORTIONAL;  // splitter specific extended styles
...
public:
	...
	{
		ReleaseUnknown(m_pD2DBrushBlack);
		ReleaseUnknown(m_pD2DBrushWhite);
		ReleaseUnknown(m_pD2DBrushBlue);
		ReleaseUnknown(m_pD2DBrushGreen);
	}
	...
	LRESULT OnCreate(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/)
	{
		...
		SetLayeredWindowAttributes(m_view.m_hWnd, 0, 255, LWA_ALPHA);
		SetLayeredWindowAttributes(m_view1.m_hWnd, 0, 255, LWA_ALPHA);

		SetSplitterPanes(m_view, m_view1, false);
		SetSplitterPosPct(60);
	...
	void DrawTitle()
	{
		ID2D1Bitmap* pBitmap = nullptr;
		const int w = 32;
		HRESULT hr = m_pD2DDeviceContext3->CreateBitmap(D2D1::SizeU(w, w), xbmpX, (w << 2),
			D2D1::BitmapProperties(D2D1::PixelFormat(DXGI_FORMAT_B8G8R8A8_UNORM, D2D1_ALPHA_MODE_PREMULTIPLIED)),
			&pBitmap);
	...
	void UpdateFrameMargins()
	{
		...
		margins.cyTopHeight = m_heightTitle;
	...
	{
		const int offset = m_heightTitle;
		ATLASSERT((nPane == SPLIT_PANE_LEFT) || (nPane == SPLIT_PANE_RIGHT));
		ATLASSERT(lpRect != NULL);
		bool bRet = true;
		if (m_nSinglePane != SPLIT_PANE_NONE)
	...
	void DrawGhostBarDx(bool bErase = false)
	{
		...
		if (m_pD2DDeviceContext3 && m_pDXGISwapChain1)
		{
			...
			if (!bErase)
			{
				...
				m_pD2DDeviceContext3->FillRectangle(D2D1::RectF(pos, static_cast<float>(m_heightTitle),
					pos + 4.0f, size.height), m_pD2DBrushGreen);
			}
			hr = m_pD2DDeviceContext3->EndDraw();
			hr = m_pDXGISwapChain1->Present(1, 0);
		}
