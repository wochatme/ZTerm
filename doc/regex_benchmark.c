...
static char* getSubjectTextFromFile(const char* filename)
{
	char* text = NULL;
...
if (argc - i != 2)
  {
  printf("Exactly two arguments required: a regex and a text file containing the subject string\n");
  return 1;
  }
...
subject = (PCRE2_SPTR)getSubjectTextFromFile(argv[i+1]);
if(subject == NULL)
{
